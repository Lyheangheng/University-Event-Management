    ...
    <div className="group bg-slate-900/70 hover:bg-slate-900 border border-slate-800 hover:border-slate-700/80 rounded-2xl overflow-hidden flex flex-col transition-all duration-300 hover:shadow-xl hover:shadow-indigo-950/30">
      ...
      <div className="p-5 flex-1 flex flex-col justify-between gap-4">
        ...
        <Link
          ...
          className="mt-2 w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-indigo-600/10 hover:bg-indigo-600 border border-indigo-500/20 hover:border-indigo-500 text-indigo-300 hover:text-white font-medium text-xs sm:text-sm transition-all duration-200"
        >
          View Details
